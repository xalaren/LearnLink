...
using RustyTail.Api.Extensions;
using RustyTail.Api.HostedServices;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.IdentityModel.Tokens;
using NLog.Web;
using Scalar.AspNetCore;
using RustyTail.Application;
using RustyTail.Adapter;
using RustyTail.SecurityProvider;
